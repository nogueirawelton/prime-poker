      ...
      <div className="mx-auto max-w-screen-2xl px-4 py-12 lg:px-8 lg:py-24">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="hover:border-prime-light flex flex-col rounded-md border border-white/3 bg-white/3 px-8 py-4 transition-all duration-500 hover:scale-105">
            <span className="text-prime-light bg-prime-red/75 grid size-14 place-items-center rounded-full">
              <CoinsIcon weight="fill" className="size-7" />
            </span>

            <h3 className="text-prime-light mt-6 gap-2 text-2xl font-bold">
              Banca
            </h3>

            <p className="text-prime-light mt-2">
          ...
          <div className="hover:border-prime-light flex flex-col rounded-md border border-white/3 bg-white/3 px-8 py-4 transition-all duration-500 hover:scale-105">
            ...
            <p className="text-prime-light mt-2">
              Sessões individuais e em grupo com os melhores coaches do Brasil,
              focadas em suas necessidades específicas.
            </p>
          </div>
        ...
        <div className="border-prime-red/75 mt-10 flex flex-col rounded-md border bg-white/3 px-8 py-6 transition-all duration-500">
          ...
          <div className="mt-8 grid gap-x-4 gap-y-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="text-prime-light flex items-center gap-3">
              <span className="bg-prime-red/75 grid size-8 place-items-center rounded-full">
            ...
            <div className="text-prime-light flex items-center gap-3">
              ...
              <strong className="font-normal">Leakfinder individual</strong>
            </div>
